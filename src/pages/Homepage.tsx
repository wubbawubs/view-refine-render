  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 relative overflow-hidden animate-fade-in">
        ...
        {/* Fade in from top */}
        <div className="absolute inset-0 bg-gradient-to-b from-white from-0% to-transparent to-20%"></div>
        
        {/* Fade out to bottom */}
        <div className="absolute inset-0 bg-gradient-to-t from-white from-0% to-transparent to-20%"></div>
