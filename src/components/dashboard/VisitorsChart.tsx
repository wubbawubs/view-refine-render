  ...
  if (active && payload && payload.length) {
    ...
    return (
      <div className="bg-card p-3 border border-border rounded-lg shadow-card">
        ...
        <p className="text-kk-label font-semibold text-foreground">Jouw bezoekers: {visitors.toLocaleString()}</p>
    ...
    return (
      <GradientCard>
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <EmptyState title="Geen data beschikbaar" description="Er zijn momenteel geen bezoekersgegevens om weer te geven." icon="database" />
        </div>
      </GradientCard>
    );
  }
        ...
        <div className="h-48 sm:h-56 lg:h-64 mb-4 w-full overflow-hidden">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data}>
              ...
              <Area type="monotone" dataKey="visitors" stroke="hsl(var(--kk-violet))" strokeWidth={3} fill="url(#visitorsGradient)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
