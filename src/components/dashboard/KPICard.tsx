  ...
  return (
    <Card 
      className={cn(
        ...
        "h-40 w-full", // Increased fixed height and full width
    ...
    >
      ...
      <div className="relative p-4 h-full flex flex-col justify-between">
        {/* Header with icon and label - fixed height section */}
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-sm font-semibold text-foreground/90 leading-tight line-clamp-1">
              {label}
            </h3>
          </div>
        </div>
        
        {/* Value section - main content */}
        ...
        {/* Bottom section - delta and help text */}
