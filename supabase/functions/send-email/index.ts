...
<table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;">
  ...
  <tr><td style="background:#ffffff;padding:32px;text-align:center;border-radius:0 0 16px 16px;">
    ...
    <p style="font-size:11px;color:#9ca3af;margin:16px 0 0;">KlikKlaar SEO |@klikklaarseo.nl<br>Je ontvangt dit bericht omdat je klant bent bij KlikKlaar SEO.</p>
  </td></tr>
</table>
</body></html>`;
}
    ...
    keywordsSection = `<tr><td style="padding:24px 32px;border-top:1px solid #e5e7eb;">
      ...
      ${keywordChanges.map(kw => {
        ...
        return `<div style="padding:8px 12px;background:#f9fafb;border-radius:8px;margin-bottom:8px;font-size:14px;">
          <strong>"${kw.keyword}"</strong> �|s| |le="color:${improved ? '#10b981' : '#ef4444'};font-weight:600;">${improved ? '↑' : '↓'} Positie ${kw.newPosition}</span> <span style="color:#9ca3af;">(was ${kw.oldPosition})</span>
        </div>`;
      }).join('')}
    </td></tr>`;
  }
